                ...
                >
                    ...
                    <div>
                        ...
                        <div className="flex justify-between items-start mb-8 gap-4">
                            <h1 className="text-5xl md:text-7xl font-display font-extrabold leading-[1.05] text-slate-900 tracking-tight">
                                {project.title}
                            </h1>
                            <a href="https://github.com/himesh220002" target="_blank" rel="noopener noreferrer" className="cursor-pointer text-slate-900 hover:text-primary transition-colors shrink-0 border border-gray-200 rounded-[1rem] p-1">
                                <svg className="w-12 h-12 md:w-[60px] md:h-[60px]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
